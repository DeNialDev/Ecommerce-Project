						...
						<div class="col-md-12 my-wishlist">
							<div class="table-responsive">
								<table class="table">
									<thead>
										<tr>
											<th colspan="4">Mi lista de regalos</th>
										</tr>
									</thead>
									<tbody>
										<?php
											...
											if ($num > 0) {
												...
												<tr>
													...
													<td class="col-md-6">
														...
														<?php $rt = mysqli_query($con, "select * from productreviews where productId='$pd'");
															...
															<div class="rating">
																...
																<span class="review">( <?php echo htmlentities($num); ?> Revision)</span>
															</div>
														<?php } ?>
														<div class="price">$.
													...
													<td class="col-md-2">
														<a href="my-wishlist.php?page=product&action=add&id=<?php echo $row['pid']; ?>" class="btn-upper btn btn-primary">Agregar al carrito</a>
													</td>
