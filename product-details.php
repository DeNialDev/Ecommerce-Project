				...
				<div class='col-md-3 sidebar'>
					<div class="sidebar-module-container">
						...
						<div class="sidebar-widget hot-deals wow fadeInUp">
							<h3 class="section-title">Mas vendido</h3>
											...
											<div class="cart clearfix animate-effect">
												<div class="action">
													<div class="add-cart-button btn-group">
														...
														<a href="product-details.php?page=product&action=add&id=<?php echo $rws['id']; ?>" class="lnk btn btn-primary">Agregar al carrito</a>
													</div>
												</div> 
											</div> 
										</div>
								...
								<div class="product-info">
									...
									<div class="stock-container info-container m-t-10">
										<div class="row">
											<div class="col-sm-3">
												<div class="stock-box">
													<span class="label">Precio de envío:</span>
												</div>
											</div>
											<div class="col-sm-9">
												<div class="stock-box">
							...
							<div class="row">
								<div class="col-sm-3">
									<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
										...
										<li><a data-toggle="tab" href="#review">Revisiones</a></li>
									</ul> 
								</div>
								<div class="col-sm-9">
										...
										<div id="review" class="tab-pane">
											<div class="product-tab">
												<div class="product-reviews">
													<h4 class="title">Revisión de clientes</h4>
													<?php $qry = mysqli_query($con, "select * from productreviews where productId='$pid'");
														...
														<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
															<div class="review">
																...
																<div class="text"><b>Calidad:</b> <?php echo htmlentities($rvw['quality']); ?> Estrallas</div>
																<div class="text"><b>Precio :</b> <?php echo htmlentities($rvw['price']); ?> Estrellas</div>
																<div class="text"><b>Valor :</b> <?php echo htmlentities($rvw['value']); ?> Estrellas</div>
												...
												<form role="form" class="cnt-form" name="review" method="post">
													<div class="product-add-review">
														<h4 class="title">Escribe tu revisión</h4>
															...
															<div class="form-container">
																<div class="row">
																	<div class="col-sm-6">
																		...
																		<div class="form-group">
																			<label for="exampleInputSummary">Sumario<span class="astk">*</span></label>
																			<input type="text" class="form-control txt" id="exampleInputSummary" placeholder="" name="summary" required="required">
																		</div> 
																	</div>
																	<div class="col-md-6">
																		<div class="form-group">
																			<label for="exampleInputReview">Revisión<span class="astk">*</span></label>
																...
																<div class="action text-right">
																	<button name="submit" class="btn btn-primary btn-upper">Enviar</button>
																</div> 
												</form> 
											</div> 
										</div> 
