...
if (isset($_POST['submit'])) {
	if (!empty($_SESSION['cart'])) {
		...
		echo "<script>alert('Tu carrito ha sido actualizado');</script>";
	}
}
									...
									<table class="table table-bordered">
										<thead>
											<tr>
												...
												<th class="cart-total last-item">Precio total</th>
											</tr>
										</thead>
										<tfoot>
											<tr>
												<td colspan="7">
													<div class="shopping-cart-btn">
														<span class="">
															...
															<input type="submit" name="submit" value="" class="btn btn-upper btn-primary pull-right outer-right-xs">
														</span>
													</div>
												</td>
											</tr>
								...
								<tr>
									<th>
										<div class="cart-grand-total">
											Precio final<span class="inner-left-md"><?php echo $_SESSION['tp'] = "$totalprice" . ".00"; ?></span>
										</div>
									</th>
								</tr>
							</thead>
								...
								<tr>
									<td>
										<div class="cart-checkout-btn pull-right">
											<button type="submit" name="ordersubmit" class="btn btn-primary">Proceder a pagar</button>
										</div>
									</td>
								</tr>
							</tbody>
